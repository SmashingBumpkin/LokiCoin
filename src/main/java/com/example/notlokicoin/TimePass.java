...
public class TimePass {
    public static Miner miner1 = Miner.startNewNetwork(2);
    public static Miner miner2 = new Miner();
    public static Miner miner3 = new Miner();
    public static Miner miner4 = new Miner();
    public static Miner miner5 = new Miner();
    public static Miner miner6 = new Miner();
